...
fig=px.scatter_mapbox(df.loc[df['price']<price_set],lat='lat',lon='long',
                      color='sqft_living',size='price')
...
multi_var=st.multiselect("Select Additional Variables for Accuracy=",
